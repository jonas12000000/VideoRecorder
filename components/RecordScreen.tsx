...
const RecordScreen = () => {
    ...
    const { isRecording, recordedBlob, recordedVideoUrl, recordingDuration, 
      startRecording, stopRecording, resetRecording} = useScreenRecording();
            ...
            <div className="dialog-content">
              ...
              <section>
                {isRecording ? (
                  <article>
                    <div />
                    <span>Recording is progress...</span>
                  </article>
                ) : recordedVideoUrl ? (
                  <video ref={videoRef} src={recordedVideoUrl} controls />
                ) : (
                  <p>Click Start to capture your screen</p>
                )}
              </section>
